    ...
    namespace Browser
    {
        namespace Core
        {
            ...
            public:
                ...
                virtual void SetReferrer(String^ referrerUrl, Fluxonaut::Browser::ReferrerPolicy policy);
                virtual property String^ ReferrerUrl { String^ get(); }
                virtual property ResourceType ResourceType { Fluxonaut::Browser::ResourceType get(); }
                virtual property ReferrerPolicy ReferrerPolicy { Fluxonaut::Browser::ReferrerPolicy get(); }
                virtual property NameValueCollection^ Headers { NameValueCollection^ get(); void set(NameValueCollection^ url); }
                virtual property TransitionType TransitionType { Fluxonaut::Browser::TransitionType get(); }
