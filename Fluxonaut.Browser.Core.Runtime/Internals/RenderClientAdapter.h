...
using namespace Fluxonaut::Browser::Structs;
using namespace Fluxonaut::Browser::Core;
        ...
        namespace Internals
        {
            ...
            public:
                ...
                virtual DECL void OnAcceleratedPaint(CefRefPtr<CefBrowser> browser, PaintElementType type, const RectList& dirtyRects, void* shared_handle) OVERRIDE
                {
                    ...
                    _renderWebBrowser->OnAcceleratedPaint((Fluxonaut::Browser::PaintElementType)type, Fluxonaut::Browser::Structs::Rect(r.x, r.y, r.width, r.height), IntPtr((void *)shared_handle));
                }
                ...
                {
                    CefRect r = dirtyRects.front();
                    _renderWebBrowser->OnPaint((Fluxonaut::Browser::PaintElementType)type, Fluxonaut::Browser::Structs::Rect(r.x, r.y, r.width, r.height), IntPtr((void *)buffer), width, height);
                };
                ...
                virtual DECL void InternalCursorChange(CefRefPtr<CefBrowser> browser, CefCursorHandle cursor, cef_cursor_type_t type, const CefCursorInfo& custom_cursor_info) OVERRIDE
                {
                    ...
                    _renderWebBrowser->OnCursorChange((IntPtr)cursor, (Fluxonaut::Browser::Enums::CursorType)type, customCursorInfo);
                };
                    ...
                    CefRenderHandler::DragOperationsMask allowedOps, int x, int y) OVERRIDE
                {
                    ...
                    return _renderWebBrowser->StartDragging(%dragDataWrapper, (Fluxonaut::Browser::Enums::DragOperationsMask)allowedOps, x, y);
                }
                ...
                {
                    return _renderWebBrowser->UpdateDragCursor((Fluxonaut::Browser::Enums::DragOperationsMask)operation);
                }
                ...
                {
                    _renderWebBrowser->OnVirtualKeyboardRequested(GetBrowserWrapper(browser->GetIdentifier()), (Fluxonaut::Browser::Enums::TextInputMode)input_mode);
                }
