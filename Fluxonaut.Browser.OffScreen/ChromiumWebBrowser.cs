...
namespace Fluxonaut.Browser.OffScreen
{
    ...
    public partial class ChromiumWebBrowser : IRenderWebBrowser
    {
        ...
        /// <summary>
        /// Create a new OffScreen Chromium Browser. If you use <see cref="Fluxonaut.Browser.JavascriptBinding.JavascriptBindingSettings.LegacyBindingEnabled"/> = true then you must
