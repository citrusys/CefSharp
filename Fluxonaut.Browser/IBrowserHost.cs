...
namespace Fluxonaut.Browser
{
    ...
    public interface IBrowserHost : IDisposable
    {
        ...
        /// <summary>
        /// Call this method when the drag operation started by a <see cref="Fluxonaut.Browser.Internals.IRenderWebBrowser.StartDragging(IDragData, DragOperationsMask, int, int)"/> call has ended either in a drop or by being cancelled.
        ...
        /// <summary>
        /// Call this method when the drag operation started by a <see cref="Fluxonaut.Browser.Internals.IRenderWebBrowser.StartDragging(IDragData, DragOperationsMask, int, int)"/> call has completed.
