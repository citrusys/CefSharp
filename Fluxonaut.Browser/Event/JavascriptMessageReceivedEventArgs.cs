...
using System;
using Fluxonaut.Browser.ModelBinding;


namespace Fluxonaut.Browser
{
    /// <summary>
    /// Calling Fluxonaut.Browser.PostMessage in Javascript triggers the JavascriptMessageReceived
    ...
    public class JavascriptMessageReceivedEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// The frame that called Fluxonaut.Browser.PostMessage in Javascript
        /// </summary>
        ...
        /// <param name="frame">The frame that called Fluxonaut.Browser.PostMessage in Javascript.</param>
        ...
        /// <see cref="DefaultBinder"/> that Fluxonaut.Browser provides
        /// </summary>
