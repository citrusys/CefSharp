...
{
    /// <summary>
    /// DependencyChecker provides a known list of Cef/Fluxonaut.Browser dependencies and 
    ...
    public static class DependencyChecker
    {
        ...
        /// <summary>
        /// List of Fluxonaut.Browser Dependencies
        /// </summary>
        ...
        /// <summary>
        /// List of Fluxonaut.Browser.BrowserSubprocess.exe dependencies.
        /// </summary>
        ...
        /// <summary>
        /// CheckDependencies iterates through the list of Cef and Fluxonaut.Browser dependencines
        ...
        /// <summary>
        /// Checks if all Cef and Fluxonaut.Browser dependencies were found relative to the Executing Assembly.
        ...
        public static void AssertAllDependenciesPresent(string locale = null, string localesDirPath = null, string resourcesDirPath = null, bool packLoadingDisabled = false, string browserSubProcessPath = "Fluxonaut.Browser.BrowserSubProcess.exe")
        {
            string path;
            ...
            if (missingDependencies.Count > 0)
            {
                ...
                builder.AppendLine("Unable to locate required Cef/FluxonautBrowser dependencies:");
