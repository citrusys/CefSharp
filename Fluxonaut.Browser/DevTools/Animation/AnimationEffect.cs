...
namespace Fluxonaut.Browser.DevTools.Animation
{
    ...
    public class AnimationEffect : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.Animation.KeyframesRule KeyframesRule
        {
            get;
            set;
        }
