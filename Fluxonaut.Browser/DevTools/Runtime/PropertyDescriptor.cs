...
namespace Fluxonaut.Browser.DevTools.Runtime
{
    ...
    public class PropertyDescriptor : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.Runtime.RemoteObject Get
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Runtime.RemoteObject Set
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Runtime.RemoteObject Symbol
        {
            get;
            set;
        }
