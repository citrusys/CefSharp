...
namespace Fluxonaut.Browser.DevTools.Runtime
{
    ...
    public class StackTrace : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Runtime.CallFrame> CallFrames
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Runtime.StackTrace Parent
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Runtime.StackTraceId ParentId
        {
            get;
            set;
        }
