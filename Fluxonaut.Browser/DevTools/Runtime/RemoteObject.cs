...
namespace Fluxonaut.Browser.DevTools.Runtime
{
    ...
    public class RemoteObject : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Object type.
        /// </summary>
        ...
        public Fluxonaut.Browser.DevTools.Runtime.ObjectPreview Preview
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Runtime.CustomPreview CustomPreview
        {
            get;
            set;
        }
