...
namespace Fluxonaut.Browser.DevTools.Target
{
    ...
    public partial class Target : DevToolsDomainBase
    {
        ...
        public Target(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateSetRemoteLocations(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Target.RemoteLocation> locations);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> SetRemoteLocationsAsync(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Target.RemoteLocation> locations)
        {
