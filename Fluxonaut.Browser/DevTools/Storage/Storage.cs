...
namespace Fluxonaut.Browser.DevTools.Storage
{
    ...
    public partial class Storage : DevToolsDomainBase
    {
        ...
        public Storage(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateSetCookies(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Network.CookieParam> cookies, string browserContextId = null);
        /// <summary>
        /// Sets given cookies.
        /// </summary>
        ...
        /// <param name = "browserContextId">Browser context to use when called on the browser endpoint.</param>
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> SetCookiesAsync(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Network.CookieParam> cookies, string browserContextId = null)
        {
