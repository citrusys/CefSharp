...
namespace Fluxonaut.Browser.DevTools.Page
{
    ...
    public class NavigationEntry : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        /// Transition type.
        /// </summary>
        public Fluxonaut.Browser.DevTools.Page.TransitionType TransitionType
        {
            get
            {
                return (Fluxonaut.Browser.DevTools.Page.TransitionType)(StringToEnum(typeof(Fluxonaut.Browser.DevTools.Page.TransitionType), transitionType));
            }
