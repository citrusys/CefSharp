...
namespace Fluxonaut.Browser.DevTools.Page
{
    ...
    public class FrameResourceTree : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Page.FrameResourceTree> ChildFrames
        {
            get;
            set;
        }
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Page.FrameResource> Resources
        {
            get;
            set;
        }
