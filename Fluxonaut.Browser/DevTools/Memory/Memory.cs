...
namespace Fluxonaut.Browser.DevTools.Memory
{
    ...
    public partial class Memory : DevToolsDomainBase
    {
        ...
        public Memory(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateSimulatePressureNotification(Fluxonaut.Browser.DevTools.Memory.PressureLevel level);
        /// <summary>
        /// Simulate a memory pressure notification in all processes.
        /// </summary>
        /// <param name = "level">Memory pressure level of the notification.</param>
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> SimulatePressureNotificationAsync(Fluxonaut.Browser.DevTools.Memory.PressureLevel level)
        {
