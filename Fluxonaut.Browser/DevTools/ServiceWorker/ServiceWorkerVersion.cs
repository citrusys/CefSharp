...
namespace Fluxonaut.Browser.DevTools.ServiceWorker
{
    ...
    public class ServiceWorkerVersion : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// VersionId
        /// </summary>
        ...
        /// RunningStatus
        /// </summary>
        public Fluxonaut.Browser.DevTools.ServiceWorker.ServiceWorkerVersionRunningStatus RunningStatus
        {
            get
            {
                return (Fluxonaut.Browser.DevTools.ServiceWorker.ServiceWorkerVersionRunningStatus)(StringToEnum(typeof(Fluxonaut.Browser.DevTools.ServiceWorker.ServiceWorkerVersionRunningStatus), runningStatus));
            }
        ...
        /// Status
        /// </summary>
        public Fluxonaut.Browser.DevTools.ServiceWorker.ServiceWorkerVersionStatus Status
        {
            get
            {
                return (Fluxonaut.Browser.DevTools.ServiceWorker.ServiceWorkerVersionStatus)(StringToEnum(typeof(Fluxonaut.Browser.DevTools.ServiceWorker.ServiceWorkerVersionStatus), status));
            }
