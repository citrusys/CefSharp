...
namespace Fluxonaut.Browser.DevTools.Accessibility
{
    ...
    public class AXNode : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Accessibility.AXProperty> IgnoredReasons
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Accessibility.AXValue Role
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Accessibility.AXValue Name
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Accessibility.AXValue Description
        {
            get;
            set;
        }
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Accessibility.AXProperty> Properties
        {
            get;
            set;
        }
