...
namespace Fluxonaut.Browser.DevTools.CSS
{
    ...
    public partial class CSS : DevToolsDomainBase
    {
        ...
        public CSS(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }

        partial void ValidateAddRule(string styleSheetId, string ruleText, Fluxonaut.Browser.DevTools.CSS.SourceRange location);
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<AddRuleResponse> AddRuleAsync(string styleSheetId, string ruleText, Fluxonaut.Browser.DevTools.CSS.SourceRange location)
        {
        ...
        partial void ValidateSetKeyframeKey(string styleSheetId, Fluxonaut.Browser.DevTools.CSS.SourceRange range, string keyText);
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<SetKeyframeKeyResponse> SetKeyframeKeyAsync(string styleSheetId, Fluxonaut.Browser.DevTools.CSS.SourceRange range, string keyText)
        {
        ...
        partial void ValidateSetMediaText(string styleSheetId, Fluxonaut.Browser.DevTools.CSS.SourceRange range, string text);
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<SetMediaTextResponse> SetMediaTextAsync(string styleSheetId, Fluxonaut.Browser.DevTools.CSS.SourceRange range, string text)
        {
        ...
        partial void ValidateSetRuleSelector(string styleSheetId, Fluxonaut.Browser.DevTools.CSS.SourceRange range, string selector);
        /// <summary>
        /// Modifies the rule selector.
        /// </summary>
        /// <param name = "styleSheetId">styleSheetId</param>
        ...
        public async System.Threading.Tasks.Task<SetRuleSelectorResponse> SetRuleSelectorAsync(string styleSheetId, Fluxonaut.Browser.DevTools.CSS.SourceRange range, string selector)
        {
        ...
        partial void ValidateSetStyleTexts(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.CSS.StyleDeclarationEdit> edits);
        /// <summary>
        /// Applies specified style edits one after another in the given order.
        /// </summary>
        /// <param name = "edits">edits</param>
        /// <returns>returns System.Threading.Tasks.Task&lt;SetStyleTextsResponse&gt;</returns>
        public async System.Threading.Tasks.Task<SetStyleTextsResponse> SetStyleTextsAsync(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.CSS.StyleDeclarationEdit> edits)
        {
