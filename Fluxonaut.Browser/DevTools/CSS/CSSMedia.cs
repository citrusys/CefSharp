...
namespace Fluxonaut.Browser.DevTools.CSS
{
    ...
    public class CSSMedia : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Media query text.
        /// </summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.CSS.MediaQuery> MediaList
        {
            get;
            set;
        }
