...
namespace Fluxonaut.Browser.DevTools.Emulation
{
    ...
    public class UserAgentMetadata : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Brands
        /// </summary>
        [System.Runtime.Serialization.DataMemberAttribute(Name = ("brands"), IsRequired = (true))]
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Emulation.UserAgentBrandVersion> Brands
        {
            get;
            set;
        }
