...
namespace Fluxonaut.Browser.DevTools.Profiler
{
    ...
    public class ScriptCoverage : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Profiler.FunctionCoverage> Functions
        {
            get;
            set;
        }
