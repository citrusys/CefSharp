...
namespace Fluxonaut.Browser.DevTools.Profiler
{
    ...
    public class ScriptTypeProfile : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Profiler.TypeProfileEntry> Entries
        {
            get;
            set;
        }
