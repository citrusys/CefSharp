...
namespace Fluxonaut.Browser.DevTools.Profiler
{
    ...
    public class Profile : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// The list of profile nodes. First item is the root node.
        /// </summary>
        [System.Runtime.Serialization.DataMemberAttribute(Name = ("nodes"), IsRequired = (true))]
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Profiler.ProfileNode> Nodes
        {
            get;
            set;
        }
