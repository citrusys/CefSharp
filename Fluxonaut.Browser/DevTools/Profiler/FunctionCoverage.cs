...
namespace Fluxonaut.Browser.DevTools.Profiler
{
    ...
    public class FunctionCoverage : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Profiler.CoverageRange> Ranges
        {
            get;
            set;
        }
