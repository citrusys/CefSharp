...
namespace Fluxonaut.Browser.DevTools.Profiler
{
    ...
    public class ProfileNode : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Profiler.PositionTickInfo> PositionTicks
        {
            get;
            set;
        }
