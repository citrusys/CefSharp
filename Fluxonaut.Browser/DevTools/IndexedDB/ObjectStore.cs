...
namespace Fluxonaut.Browser.DevTools.IndexedDB
{
    ...
    public class ObjectStore : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Object store name.
        /// </summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.IndexedDB.ObjectStoreIndex> Indexes
        {
            get;
            set;
        }
