...
namespace Fluxonaut.Browser.DevTools.IndexedDB
{
    ...
    public partial class IndexedDB : DevToolsDomainBase
    {
        ...
        public IndexedDB(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateDeleteObjectStoreEntries(string securityOrigin, string databaseName, string objectStoreName, Fluxonaut.Browser.DevTools.IndexedDB.KeyRange keyRange);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> DeleteObjectStoreEntriesAsync(string securityOrigin, string databaseName, string objectStoreName, Fluxonaut.Browser.DevTools.IndexedDB.KeyRange keyRange)
        {
        ...
        partial void ValidateRequestData(string securityOrigin, string databaseName, string objectStoreName, string indexName, int skipCount, int pageSize, Fluxonaut.Browser.DevTools.IndexedDB.KeyRange keyRange = null);
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<RequestDataResponse> RequestDataAsync(string securityOrigin, string databaseName, string objectStoreName, string indexName, int skipCount, int pageSize, Fluxonaut.Browser.DevTools.IndexedDB.KeyRange keyRange = null)
        {
