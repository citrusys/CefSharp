...
namespace Fluxonaut.Browser.DevTools.IndexedDB
{
    ...
    public class KeyRange : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Lower bound.
        /// </summary>
        [System.Runtime.Serialization.DataMemberAttribute(Name = ("lower"), IsRequired = (false))]
        public Fluxonaut.Browser.DevTools.IndexedDB.Key Lower
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.IndexedDB.Key Upper
        {
            get;
            set;
        }
