...
namespace Fluxonaut.Browser.DevTools.DOMSnapshot
{
    ...
    public class LayoutTreeSnapshot : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareBooleanData StackingContexts
        {
            get;
            set;
        }
