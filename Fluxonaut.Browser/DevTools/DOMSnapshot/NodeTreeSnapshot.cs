...
namespace Fluxonaut.Browser.DevTools.DOMSnapshot
{
    ...
    public class NodeTreeSnapshot : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Parent node index.
        /// </summary>
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareStringData TextValue
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareStringData InputValue
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareBooleanData InputChecked
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareBooleanData OptionSelected
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareIntegerData ContentDocumentIndex
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareStringData PseudoType
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareBooleanData IsClickable
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareStringData CurrentSourceURL
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.RareStringData OriginURL
        {
            get;
            set;
        }
