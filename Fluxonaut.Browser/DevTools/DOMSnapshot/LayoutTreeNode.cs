...
namespace Fluxonaut.Browser.DevTools.DOMSnapshot
{
    ...
    public class LayoutTreeNode : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.DOM.Rect BoundingBox
        {
            get;
            set;
        }
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.DOMSnapshot.InlineTextBox> InlineTextNodes
        {
            get;
            set;
        }
