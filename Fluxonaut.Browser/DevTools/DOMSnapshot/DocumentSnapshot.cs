...
namespace Fluxonaut.Browser.DevTools.DOMSnapshot
{
    ...
    public class DocumentSnapshot : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.NodeTreeSnapshot Nodes
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.LayoutTreeSnapshot Layout
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOMSnapshot.TextBoxSnapshot TextBoxes
        {
            get;
            set;
        }
