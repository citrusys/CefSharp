...
namespace Fluxonaut.Browser.DevTools.DOMSnapshot
{
    ...
    public class DOMNode : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// `Node`'s nodeType.
        /// </summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.DOMSnapshot.NameValue> Attributes
        {
            get;
            set;
        }
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.DOMDebugger.EventListener> EventListeners
        {
            get;
            set;
        }
