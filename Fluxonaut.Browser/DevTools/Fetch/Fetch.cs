...
namespace Fluxonaut.Browser.DevTools.Fetch
{
    ...
    public partial class Fetch : DevToolsDomainBase
    {
        ...
        public Fetch(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateEnable(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Fetch.RequestPattern> patterns = null, bool? handleAuthRequests = null);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> EnableAsync(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Fetch.RequestPattern> patterns = null, bool? handleAuthRequests = null)
        {
        ...
        partial void ValidateFailRequest(string requestId, Fluxonaut.Browser.DevTools.Network.ErrorReason errorReason);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> FailRequestAsync(string requestId, Fluxonaut.Browser.DevTools.Network.ErrorReason errorReason)
        {
        ...
        partial void ValidateFulfillRequest(string requestId, int responseCode, System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Fetch.HeaderEntry> responseHeaders = null, byte[] binaryResponseHeaders = null, byte[] body = null, string responsePhrase = null);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> FulfillRequestAsync(string requestId, int responseCode, System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Fetch.HeaderEntry> responseHeaders = null, byte[] binaryResponseHeaders = null, byte[] body = null, string responsePhrase = null)
        {
        ...
        partial void ValidateContinueRequest(string requestId, string url = null, string method = null, string postData = null, System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Fetch.HeaderEntry> headers = null);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> ContinueRequestAsync(string requestId, string url = null, string method = null, string postData = null, System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Fetch.HeaderEntry> headers = null)
        {
        ...
        partial void ValidateContinueWithAuth(string requestId, Fluxonaut.Browser.DevTools.Fetch.AuthChallengeResponse authChallengeResponse);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> ContinueWithAuthAsync(string requestId, Fluxonaut.Browser.DevTools.Fetch.AuthChallengeResponse authChallengeResponse)
        {
