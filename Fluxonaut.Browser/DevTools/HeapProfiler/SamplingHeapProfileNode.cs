...
namespace Fluxonaut.Browser.DevTools.HeapProfiler
{
    ...
    public class SamplingHeapProfileNode : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Function location.
        /// </summary>
        [System.Runtime.Serialization.DataMemberAttribute(Name = ("callFrame"), IsRequired = (true))]
        public Fluxonaut.Browser.DevTools.Runtime.CallFrame CallFrame
        {
            get;
            set;
        }
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.HeapProfiler.SamplingHeapProfileNode> Children
        {
            get;
            set;
        }
