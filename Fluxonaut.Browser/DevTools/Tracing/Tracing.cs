...
namespace Fluxonaut.Browser.DevTools.Tracing
{
    ...
    public partial class Tracing : DevToolsDomainBase
    {
        ...
        public Tracing(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateStart(string categories = null, string options = null, long? bufferUsageReportingInterval = null, string transferMode = null, Fluxonaut.Browser.DevTools.Tracing.StreamFormat? streamFormat = null, Fluxonaut.Browser.DevTools.Tracing.StreamCompression? streamCompression = null, Fluxonaut.Browser.DevTools.Tracing.TraceConfig traceConfig = null);
        /// <summary>
