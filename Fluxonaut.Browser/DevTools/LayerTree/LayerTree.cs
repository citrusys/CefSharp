...
namespace Fluxonaut.Browser.DevTools.LayerTree
{
    ...
    public partial class LayerTree : DevToolsDomainBase
    {
        ...
        public LayerTree(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateLoadSnapshot(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.LayerTree.PictureTile> tiles);
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<LoadSnapshotResponse> LoadSnapshotAsync(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.LayerTree.PictureTile> tiles)
        {
        ...
        partial void ValidateProfileSnapshot(string snapshotId, int? minRepeatCount = null, long? minDuration = null, Fluxonaut.Browser.DevTools.DOM.Rect clipRect = null);
        /// <summary>
        /// ProfileSnapshot
        /// </summary>
        ...
        public async System.Threading.Tasks.Task<ProfileSnapshotResponse> ProfileSnapshotAsync(string snapshotId, int? minRepeatCount = null, long? minDuration = null, Fluxonaut.Browser.DevTools.DOM.Rect clipRect = null)
        {
