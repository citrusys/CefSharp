...
namespace Fluxonaut.Browser.DevTools.LayerTree
{
    ...
    public class Layer : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.LayerTree.ScrollRect> ScrollRects
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.LayerTree.StickyPositionConstraint StickyPositionConstraint
        {
            get;
            set;
        }
