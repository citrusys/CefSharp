...
namespace Fluxonaut.Browser.DevTools.Log
{
    ...
    public partial class Log : DevToolsDomainBase
    {
        ...
        public Log(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateStartViolationsReport(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Log.ViolationSetting> config);
        /// <summary>
        /// start violation reporting.
        /// </summary>
        /// <param name = "config">Configuration for violations.</param>
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> StartViolationsReportAsync(System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Log.ViolationSetting> config)
        {
