...
namespace Fluxonaut.Browser.DevTools.Log
{
    ...
    public class LogEntry : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Log entry source.
        /// </summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Runtime.RemoteObject> Args
        {
            get;
            set;
        }
