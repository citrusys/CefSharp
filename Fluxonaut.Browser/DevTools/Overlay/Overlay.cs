...
namespace Fluxonaut.Browser.DevTools.Overlay
{
    ...
    public partial class Overlay : DevToolsDomainBase
    {
        ...
        public Overlay(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateGetHighlightObjectForTest(int nodeId, bool? includeDistance = null, bool? includeStyle = null, Fluxonaut.Browser.DevTools.Overlay.ColorFormat? colorFormat = null, bool? showAccessibilityInfo = null);
        /// <summary>
        /// For testing.
        /// </summary>
        ...
        public async System.Threading.Tasks.Task<GetHighlightObjectForTestResponse> GetHighlightObjectForTestAsync(int nodeId, bool? includeDistance = null, bool? includeStyle = null, Fluxonaut.Browser.DevTools.Overlay.ColorFormat? colorFormat = null, bool? showAccessibilityInfo = null)
        {
        ...
        partial void ValidateHighlightFrame(string frameId, Fluxonaut.Browser.DevTools.DOM.RGBA contentColor = null, Fluxonaut.Browser.DevTools.DOM.RGBA contentOutlineColor = null);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> HighlightFrameAsync(string frameId, Fluxonaut.Browser.DevTools.DOM.RGBA contentColor = null, Fluxonaut.Browser.DevTools.DOM.RGBA contentOutlineColor = null)
        {
        ...
        partial void ValidateHighlightNode(Fluxonaut.Browser.DevTools.Overlay.HighlightConfig highlightConfig, int? nodeId = null, int? backendNodeId = null, string objectId = null, string selector = null);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> HighlightNodeAsync(Fluxonaut.Browser.DevTools.Overlay.HighlightConfig highlightConfig, int? nodeId = null, int? backendNodeId = null, string objectId = null, string selector = null)
        {
        ...
        partial void ValidateHighlightQuad(long[] quad, Fluxonaut.Browser.DevTools.DOM.RGBA color = null, Fluxonaut.Browser.DevTools.DOM.RGBA outlineColor = null);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> HighlightQuadAsync(long[] quad, Fluxonaut.Browser.DevTools.DOM.RGBA color = null, Fluxonaut.Browser.DevTools.DOM.RGBA outlineColor = null)
        {
        ...
        partial void ValidateHighlightRect(int x, int y, int width, int height, Fluxonaut.Browser.DevTools.DOM.RGBA color = null, Fluxonaut.Browser.DevTools.DOM.RGBA outlineColor = null);
        /// <summary>
        ...
        /// <param name = "outlineColor">The highlight outline color (default: transparent).</param>
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> HighlightRectAsync(int x, int y, int width, int height, Fluxonaut.Browser.DevTools.DOM.RGBA color = null, Fluxonaut.Browser.DevTools.DOM.RGBA outlineColor = null)
        {
        ...
        partial void ValidateSetInspectMode(Fluxonaut.Browser.DevTools.Overlay.InspectMode mode, Fluxonaut.Browser.DevTools.Overlay.HighlightConfig highlightConfig = null);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> SetInspectModeAsync(Fluxonaut.Browser.DevTools.Overlay.InspectMode mode, Fluxonaut.Browser.DevTools.Overlay.HighlightConfig highlightConfig = null)
        {
        ...
        partial void ValidateSetShowHinge(Fluxonaut.Browser.DevTools.Overlay.HingeConfig hingeConfig = null);
        /// <summary>
        /// Add a dual screen device hinge
        /// </summary>
        /// <param name = "hingeConfig">hinge data, null means hideHinge</param>
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> SetShowHingeAsync(Fluxonaut.Browser.DevTools.Overlay.HingeConfig hingeConfig = null)
        {
