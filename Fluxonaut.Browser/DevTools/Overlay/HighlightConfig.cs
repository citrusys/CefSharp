...
namespace Fluxonaut.Browser.DevTools.Overlay
{
    ...
    public class HighlightConfig : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA PaddingColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA BorderColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA MarginColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA EventTargetColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA ShapeColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA ShapeMarginColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA CssGridColor
        {
            get;
            set;
        }
        ...
        /// </summary>
        public Fluxonaut.Browser.DevTools.Overlay.ColorFormat? ColorFormat
        {
            get
            {
                return (Fluxonaut.Browser.DevTools.Overlay.ColorFormat? )(StringToEnum(typeof(Fluxonaut.Browser.DevTools.Overlay.ColorFormat? ), colorFormat));
            }
        ...
        public Fluxonaut.Browser.DevTools.Overlay.GridHighlightConfig GridHighlightConfig
        {
            get;
            set;
        }
