...
namespace Fluxonaut.Browser.DevTools.Overlay
{
    ...
    public class GridHighlightConfig : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA GridBorderColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA CellBorderColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA RowGapColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA RowHatchColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA ColumnGapColor
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.DOM.RGBA ColumnHatchColor
        {
            get;
            set;
        }
