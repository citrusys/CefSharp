...
namespace Fluxonaut.Browser.DevTools.CacheStorage
{
    ...
    public partial class CacheStorage : DevToolsDomainBase
    {
        ...
        public CacheStorage(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateRequestCachedResponse(string cacheId, string requestURL, System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.CacheStorage.Header> requestHeaders);
        /// <summary>
        /// Fetches cache entry.
        /// </summary>
        ...
        public async System.Threading.Tasks.Task<RequestCachedResponseResponse> RequestCachedResponseAsync(string cacheId, string requestURL, System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.CacheStorage.Header> requestHeaders)
        {
