...
namespace Fluxonaut.Browser.DevTools.CacheStorage
{
    ...
    public class DataEntry : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Request URL.
        /// </summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.CacheStorage.Header> RequestHeaders
        {
            get;
            set;
        }
        ...
        /// HTTP response type
        /// </summary>
        public Fluxonaut.Browser.DevTools.CacheStorage.CachedResponseType ResponseType
        {
            get
            {
                return (Fluxonaut.Browser.DevTools.CacheStorage.CachedResponseType)(StringToEnum(typeof(Fluxonaut.Browser.DevTools.CacheStorage.CachedResponseType), responseType));
            }
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.CacheStorage.Header> ResponseHeaders
        {
            get;
            set;
        }
