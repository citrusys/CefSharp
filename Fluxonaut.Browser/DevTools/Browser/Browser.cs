...
namespace Fluxonaut.Browser.DevTools.Browser
{
    ...
    public partial class Browser : DevToolsDomainBase
    {
        ...
        public Browser(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }

        partial void ValidateSetPermission(Fluxonaut.Browser.DevTools.Browser.PermissionDescriptor permission, Fluxonaut.Browser.DevTools.Browser.PermissionSetting setting, string origin = null, string browserContextId = null);
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> SetPermissionAsync(Fluxonaut.Browser.DevTools.Browser.PermissionDescriptor permission, Fluxonaut.Browser.DevTools.Browser.PermissionSetting setting, string origin = null, string browserContextId = null)
        {
        ...
        partial void ValidateGrantPermissions(Fluxonaut.Browser.DevTools.Browser.PermissionType[] permissions, string origin = null, string browserContextId = null);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> GrantPermissionsAsync(Fluxonaut.Browser.DevTools.Browser.PermissionType[] permissions, string origin = null, string browserContextId = null)
        {
        ...
        partial void ValidateSetWindowBounds(int windowId, Fluxonaut.Browser.DevTools.Browser.Bounds bounds);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> SetWindowBoundsAsync(int windowId, Fluxonaut.Browser.DevTools.Browser.Bounds bounds)
        {
