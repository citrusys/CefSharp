...
namespace Fluxonaut.Browser.DevTools.Debugger
{
    ...
    public class Scope : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// Scope type.
        /// </summary>
        ...
        public Fluxonaut.Browser.DevTools.Debugger.Location StartLocation
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Debugger.Location EndLocation
        {
            get;
            set;
        }
