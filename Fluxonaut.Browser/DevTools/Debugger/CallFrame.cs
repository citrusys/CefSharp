...
namespace Fluxonaut.Browser.DevTools.Debugger
{
    ...
    public class CallFrame : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.Debugger.Location FunctionLocation
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Debugger.Location Location
        {
            get;
            set;
        }
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Debugger.Scope> ScopeChain
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Runtime.RemoteObject This
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Runtime.RemoteObject ReturnValue
        {
            get;
            set;
        }
