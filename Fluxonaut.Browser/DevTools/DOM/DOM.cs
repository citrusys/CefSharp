...
namespace Fluxonaut.Browser.DevTools.DOM
{
    ...
    public partial class DOM : DevToolsDomainBase
    {
        ...
        public DOM(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateScrollIntoViewIfNeeded(int? nodeId = null, int? backendNodeId = null, string objectId = null, Fluxonaut.Browser.DevTools.DOM.Rect rect = null);
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> ScrollIntoViewIfNeededAsync(int? nodeId = null, int? backendNodeId = null, string objectId = null, Fluxonaut.Browser.DevTools.DOM.Rect rect = null)
        {
