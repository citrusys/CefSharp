...
namespace Fluxonaut.Browser.DevTools.DOMDebugger
{
    ...
    public partial class DOMDebugger : DevToolsDomainBase
    {
        ...
        public DOMDebugger(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }
        ...
        partial void ValidateRemoveDOMBreakpoint(int nodeId, Fluxonaut.Browser.DevTools.DOMDebugger.DOMBreakpointType type);
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> RemoveDOMBreakpointAsync(int nodeId, Fluxonaut.Browser.DevTools.DOMDebugger.DOMBreakpointType type)
        {
        ...
        partial void ValidateSetDOMBreakpoint(int nodeId, Fluxonaut.Browser.DevTools.DOMDebugger.DOMBreakpointType type);
        /// <summary>
        ...
        /// <returns>returns System.Threading.Tasks.Task&lt;DevToolsMethodResponse&gt;</returns>
        public async System.Threading.Tasks.Task<DevToolsMethodResponse> SetDOMBreakpointAsync(int nodeId, Fluxonaut.Browser.DevTools.DOMDebugger.DOMBreakpointType type)
        {
