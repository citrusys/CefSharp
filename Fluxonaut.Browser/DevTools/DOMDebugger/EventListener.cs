...
namespace Fluxonaut.Browser.DevTools.DOMDebugger
{
    ...
    public class EventListener : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.Runtime.RemoteObject Handler
        {
            get;
            set;
        }
        ...
        public Fluxonaut.Browser.DevTools.Runtime.RemoteObject OriginalHandler
        {
            get;
            set;
        }
