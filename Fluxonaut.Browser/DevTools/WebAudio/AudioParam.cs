...
namespace Fluxonaut.Browser.DevTools.WebAudio
{
    ...
    public class AudioParam : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// ParamId
        /// </summary>
        ...
        /// Rate
        /// </summary>
        public Fluxonaut.Browser.DevTools.WebAudio.AutomationRate Rate
        {
            get
            {
                return (Fluxonaut.Browser.DevTools.WebAudio.AutomationRate)(StringToEnum(typeof(Fluxonaut.Browser.DevTools.WebAudio.AutomationRate), rate));
            }
