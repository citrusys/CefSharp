...
namespace Fluxonaut.Browser.DevTools.Network
{
    ...
    public class Response : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public Fluxonaut.Browser.DevTools.Network.ResourceTiming Timing
        {
            get;
            set;
        }
        ...
        /// </summary>
        public Fluxonaut.Browser.DevTools.Network.ServiceWorkerResponseSource? ServiceWorkerResponseSource
        {
            get
            {
                return (Fluxonaut.Browser.DevTools.Network.ServiceWorkerResponseSource? )(StringToEnum(typeof(Fluxonaut.Browser.DevTools.Network.ServiceWorkerResponseSource? ), serviceWorkerResponseSource));
            }
