...
namespace Fluxonaut.Browser.DevTools.Network
{
    ...
    public class BlockedSetCookieWithReason : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        /// The reason(s) this cookie was blocked.
        /// </summary>
        public Fluxonaut.Browser.DevTools.Network.SetCookieBlockedReason[] BlockedReasons
        {
            get
            {
                return (Fluxonaut.Browser.DevTools.Network.SetCookieBlockedReason[])(StringToEnum(typeof(Fluxonaut.Browser.DevTools.Network.SetCookieBlockedReason[]), blockedReasons));
            }
