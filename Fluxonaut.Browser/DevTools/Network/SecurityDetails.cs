...
namespace Fluxonaut.Browser.DevTools.Network
{
    ...
    public class SecurityDetails : Fluxonaut.Browser.DevTools.DevToolsDomainEntityBase
    {
        /// <summary>
        ...
        public System.Collections.Generic.IList<Fluxonaut.Browser.DevTools.Network.SignedCertificateTimestamp> SignedCertificateTimestampList
        {
            get;
            set;
        }
        ...
        /// </summary>
        public Fluxonaut.Browser.DevTools.Network.CertificateTransparencyCompliance CertificateTransparencyCompliance
        {
            get
            {
                return (Fluxonaut.Browser.DevTools.Network.CertificateTransparencyCompliance)(StringToEnum(typeof(Fluxonaut.Browser.DevTools.Network.CertificateTransparencyCompliance), certificateTransparencyCompliance));
            }
