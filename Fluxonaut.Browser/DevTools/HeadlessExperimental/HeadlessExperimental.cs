...
namespace Fluxonaut.Browser.DevTools.HeadlessExperimental
{
    ...
    public partial class HeadlessExperimental : DevToolsDomainBase
    {
        ...
        public HeadlessExperimental(Fluxonaut.Browser.DevTools.IDevToolsClient client)
        {
            _client = (client);
        }

        partial void ValidateBeginFrame(long? frameTimeTicks = null, long? interval = null, bool? noDisplayUpdates = null, Fluxonaut.Browser.DevTools.HeadlessExperimental.ScreenshotParams screenshot = null);
        /// <summary>
        ...
        public async System.Threading.Tasks.Task<BeginFrameResponse> BeginFrameAsync(long? frameTimeTicks = null, long? interval = null, bool? noDisplayUpdates = null, Fluxonaut.Browser.DevTools.HeadlessExperimental.ScreenshotParams screenshot = null)
        {
