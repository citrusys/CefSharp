...
namespace Fluxonaut.Browser.Lagacy
{
    /// <summary>
    ...
    public class ResourceHandler : IResourceHandler
    {
        ...
        /// </summary>
        /// <param name="mimeType">Optional mimeType defaults to <see cref="Fluxonaut.Browser.ResourceHandler.DefaultMimeType"/></param>
        ...
        public ResourceHandler(string mimeType = Fluxonaut.Browser.ResourceHandler.DefaultMimeType, Stream stream = null, bool autoDisposeStream = false, string charset = null)
        {
