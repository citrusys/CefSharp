...
namespace Fluxonaut.Browser.SchemeHandler
{
    /// <summary>
    ...
    /// creating a setting the rootFolder to c:\projects\Fluxonaut.Browser\Fluxonaut.Browser.Example\Resources
    ...
    public class FolderSchemeHandlerFactory : ISchemeHandlerFactory
    {
        ...
        /// not directly avaliable as it exists in Fluxonaut.Browser.Core, to get around this we set
