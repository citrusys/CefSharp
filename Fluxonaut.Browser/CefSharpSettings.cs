...
{
    /// <summary>
    /// Use this static class to configure some Fluxonaut.Browser specific settings like WcfTimeout
    /// </summary>
    public static class CefSharpSettings
    {
        ...
        /// <summary>
        /// Fluxonaut.Browser.BrowserSubprocess will monitor the parent process and exit if the parent process closes
