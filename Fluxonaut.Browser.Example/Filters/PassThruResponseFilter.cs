...
namespace Fluxonaut.Browser.Example.Filters
{
    /// <summary>
    ...
    /// Make sure to ask your question in the context of the CEF API (remember that Fluxonaut.Browser is just a wrapper).
