...
namespace Fluxonaut.Browser.Example
{
    public class CefSharpSchemeHandlerFactory : ISchemeHandlerFactory
    {
        ...
        public IResourceHandler Create(IBrowser browser, IFrame frame, string schemeName, IRequest request)
        {
            ...
            if (fileName.EndsWith("Fluxonaut.Browser.Core.xml", StringComparison.OrdinalIgnoreCase))
            {
            ...
            if (fileName.EndsWith("Logo.png", StringComparison.OrdinalIgnoreCase))
            {
                ...
                //mimeType is optional and will default to text/html
                return ResourceHandler.FromFilePath("..\\..\\..\\..\\Fluxonaut.Browser.WinForms.Example\\Resources\\chromium-256.png", mimeType, autoDisposeStream: true);
            }

            if (uri.Host == "fluxonaut.com" && schemeName == "https" && (string.Equals(fileName, "/PostDataTest.html", StringComparison.OrdinalIgnoreCase) ||
