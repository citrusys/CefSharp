...
namespace Fluxonaut.Browser.Example.Handlers
{
    ...
    {
        public static readonly string VersionNumberString = String.Format("Chromium: {0}, CEF: {1}, FluxonautBrowser: {2}",
        ...
        protected override IResourceRequestHandler GetResourceRequestHandler(IWebBrowser chromiumWebBrowser, IBrowser browser, IFrame frame, IRequest request, bool isNavigation, bool isDownload, string requestInitiator, ref bool disableDefaultHandling)
        {
            ...
            if (request.Url.ToLower().StartsWith("https://fluxonaut.example")
