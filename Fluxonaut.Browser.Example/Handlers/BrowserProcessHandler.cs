...
namespace Fluxonaut.Browser.Example.Handlers
{
    public class BrowserProcessHandler : IBrowserProcessHandler
    {
        ...
        void IBrowserProcessHandler.OnContextInitialized()
        {
            ...
            if (cookieManager.SetCookie("custom://fluxonaut/home.html", new Cookie
            {
                Name = "FluxonautBrowserTestCookie",
                Value = "ILikeCookies",
                Expires = DateTime.Now.AddDays(1)
            }))
            {
                cookieManager.VisitUrlCookiesAsync("custom://fluxonautbrowser/home.html", false).ContinueWith(previous =>
                {
            ...
            using (var context = Cef.GetGlobalRequestContext())
            {
                ...
                //In this example we register the FolderSchemeHandlerFactory for https://fluxonaut.example
                ...
                var folderSchemeHandlerExample = new FolderSchemeHandlerFactory(rootFolder: @"..\..\..\..\Fluxonaut.Browser.Example\Resources",
                                                                        hostName: "fluxonaut.browser.example", //Optional param no hostname checking if null
                                                                        defaultPage: "home.html"); //Optional param will default to index.html

                context.RegisterSchemeHandlerFactory("https", "fluxonaut.browser.example", folderSchemeHandlerExample);
            }
        }
