...
using System.IO;
using System.Text;
using Fluxonaut.Browser.Example.Filters;
using Fluxonaut.Browser.Handler;
using Fluxonaut.Browser.ResponseFilter;
...
namespace Fluxonaut.Browser.Example.Handlers
{
    ...
    public class ExampleResourceRequestHandler : ResourceRequestHandler
    {
        ...
        protected override CefReturnValue OnBeforeResourceLoad(IWebBrowser chromiumWebBrowser, IBrowser browser, IFrame frame, IRequest request, IRequestCallback callback)
        {
            ...
            //headers["User-Agent"] = userAgent + " FluxonautBrowser";
        ...
        protected override IResponseFilter GetResourceResponseFilter(IWebBrowser chromiumWebBrowser, IBrowser browser, IFrame frame, IRequest request, IResponse response)
        {
            ...
            if (url.Scheme == CefSharpSchemeHandlerFactory.SchemeName)
            {
                ...
                if (request.Url.Equals("custom://fluxonaut/assets/js/jquery.js", StringComparison.OrdinalIgnoreCase))
                {
                    return new AppendResponseFilter(System.Environment.NewLine + "//FluxonautBrowser Appended this comment.");
                }
