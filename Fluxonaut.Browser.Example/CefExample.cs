...
namespace Fluxonaut.Browser.Example
{
    public static class CefExample
    {
        ...
        public static void Init(CefSettingsBase settings, IBrowserProcessHandler browserProcessHandler)
        {
            ...
            //NOTE: Not all relevant in relation to `Fluxonaut.Browser`, use for reference purposes only.
            ...
            //settings.UserAgent = "Fluxonaut Browser" + Cef.FluxonautbrowserVersion; // Example User Agent
            ...
            Cef.AddCrossOriginWhitelistEntry(BaseUrl, "https", "fluxonaut.com", false);
        }
