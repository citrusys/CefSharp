// Copyright © 2011 The Fluxonaut Authors. All rights reserved.
//
...
using Fluxonaut.Browser.Wpf.Example.Controls;
            ...
            if (BrowserTabs.Count > 0)
            {
                ...
                else if (param == "LoadExtension")
                {
                    ...
                    if (browser.Address.StartsWith("http"))
                    {
                        ...
                        var dir = Path.Combine(AppContext.BaseDirectory, @"..\..\..\..\Fluxonaut.Browser.Example\Extensions");
