...
namespace Fluxonaut.Browser.Wpf.Example.ViewModels
{
    public class BrowserTabViewModel : ViewModelBase
    {
        ...
        public BrowserTabViewModel(string address)
        {
            ...
            var version = string.Format("Chromium: {0}, CEF: {1}, FluxonautBrowser: {2}", Cef.ChromiumVersion, Cef.CefVersion, Cef.CefSharpVersion);
