// Copyright © 2017 The Fluxonaut Authors. All rights reserved.
//
...
namespace Fluxonaut.Browser.Wpf.Example.Controls
{
    /// <summary>
    ...
    public class ChromiumWebBrowserWithScreenshotSupport : ChromiumWebBrowser
    {
        ...
        protected override Fluxonaut.Browser.Structs.Rect GetViewRect()
        {
            if (isTakingScreenshot)
            {
                return new Fluxonaut.Browser.Structs.Rect(0, 0, (int)Math.Ceiling(screenshotSize.Value.Width), (int)Math.Ceiling(screenshotSize.Value.Height));
            }
