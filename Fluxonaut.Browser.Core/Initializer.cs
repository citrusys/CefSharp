        ...
        internal static void ModuleInitializer()
        {
            ...
            else
            {
                ...
                if (File.Exists(libCefPath))
                {
                    ...
                    if (LibCefLoaded)
                    {
                        BrowserSubProcessPath = Path.Combine(currentFolder, archFolder, "Fluxonaut.Browser.BrowserSubprocess.exe");
                        BrowserSubProcessCorePath = Path.Combine(currentFolder, archFolder, "Fluxonaut.Browser.BrowserSubprocess.Core.dll");
                        LibCefPath = libCefPath;
                        LibCefHandle = handle;
                    }
                }
