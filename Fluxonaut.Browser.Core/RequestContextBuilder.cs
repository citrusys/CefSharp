...
namespace Fluxonaut.Browser
{
    ...
    public class RequestContextBuilder
    {
        ...
        public IRequestContext Create()
        {
            if (_otherContext != null)
            {
                return new Fluxonaut.Browser.Core.RequestContext(_otherContext, _handler);
            }

            if (_settings != null)
            {
                return new Fluxonaut.Browser.Core.RequestContext(_settings.settings, _handler);
            }

            return new Fluxonaut.Browser.Core.RequestContext(_handler);
        }
