...
namespace Fluxonaut.Browser
{
    ...
    {
        private Fluxonaut.Browser.Core.UrlRequest urlRequest;
        ...
        public UrlRequest(IRequest request, IUrlRequestClient urlRequestClient, IRequestContext requestContext)
        {
            ...
            urlRequest = new Fluxonaut.Browser.Core.UrlRequest(request.UnWrap(), urlRequestClient, requestContext?.UnWrap());
        }
