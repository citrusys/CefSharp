...
namespace Fluxonaut
{
    namespace Browser
    {
        ...
        public:
            ...
            /// <see cref="Fluxonaut::Browser::LogSeverity::Disable"/> no messages will be written to the log file, but Fatal messages will still be
            ...
            /// </summary>
            property Fluxonaut::Browser::LogSeverity LogSeverity
            {
                Fluxonaut::Browser::LogSeverity get() { return (Fluxonaut::Browser::LogSeverity)_cefSettings->log_severity; }
                void set(Fluxonaut::Browser::LogSeverity value) { _cefSettings->log_severity = (cef_log_severity_t)value; }
            }
