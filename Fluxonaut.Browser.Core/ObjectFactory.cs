...
namespace Fluxonaut.Browser.Core
{
    ...
    {
        public static readonly Type BrowserSetingsType = typeof(Fluxonaut.Browser.Core.BrowserSettings);
        public static readonly Type RequestContextType = typeof(Fluxonaut.Browser.Core.RequestContext);
        ...
        {
            return new Fluxonaut.Browser.Core.WindowInfo();
        }
        ...
        {
            return new Fluxonaut.Browser.Core.UrlRequest(request, urlRequestClient);
        }
        ...
        {
            return new Fluxonaut.Browser.Core.UrlRequest(request, urlRequestClient, requestContext);
        }
